...
<head>
    ...
    <title>De Buena Salud Centro Médico</title>
...
<body data-bs-target="navbar" data-bs-spy="scroll" class="scrollspy">
<header>
<nav id="navbar" class="navbar navbar-expand-lg bgNav navFixed navbar-dark" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="2000">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="img/logo.png" alt="Logo del centro médico" class="logoImg"></a>
        ...
        <div class="row">
          ...
          <a class="text-color-nav nav-link fontSizeNav separarElementos text-center colorVerde" href="#CONTACTO"><i class="fa-regular fa-envelope"></i> CONTACTO</a>
            ...
            <li class="text-center">
                ...
                <a href="https://www.instagram.com"><i class="fa-brands fa-instagram fa-beat-fade fa-lg  text-color-nav nav-link  fontSizeNav colorVerde"></i></a>&nbsp;&nbsp;&nbsp; 
            </li>  
            </div>
        </div>
           </ul>
...
<div id="carouselExampleDark" class="carousel carousel-dark slide espacioParaFixNav" data-aos="flip-up" data-aos-duration="1500">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      ...
      <div class="carousel-caption d-md-block textoSlider">
        <h5>BIENVENIDOS A NUESTRO CENTRO MÉDICO: CUIDAMOS DE TU SALUD Y BIENESTAR</h5>
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="img/img2.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-md-block textoSlider">
        <h5>EQUIPO MÉDICO EXPERTO EN  TECNOLOGÍA DE VANGUARDIA A TU SERVICIO</h5>
      </div>
    </div>
    <div class="carousel-item">
      <img src="img/img4.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-md-block textoSlider">
        <h5>BIENESTAR INTEGRAL: ENFOCADOS EN CUIDAR DE TI, TU MENTE Y CUERPO</h5>
      </div>
    </div>
  </div>
...
<a id="SERVICIOS"></a>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
    <h5 class="text-white text-center">SERVICIO DE PEDIATRÍA</h5>
    <p class="text-white">Nuestro Servicio de Pediatría se compone de médicos especializados, dedicados al cuidado y tratamiento de niños desde el nacimiento hasta la adolescencia. 
      Nuestro equipo de profesionales altamente capacitados y experimentados se dedica a promover la salud y bienestar de los pequeños, así como a diagnosticar y tratar una amplia 
      variedad de condiciones pediátricas. Los pediatras de De Buena Cepa Centro Médico se centran en la prevención, detección temprana de problemas de salud y en el continuo seguimiento
       del crecimiento de los niños y adolescentes. En De Buena Cepa, valoramos la cercanía con nuestros pacientes y nos esforzamos por crear un ambiente amigable y acogedor para que los
        niños se sientan cómodos y seguros durante sus visitas.  
    </p>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
      <div class="ratio ratio-16x9">
        <iframe src="https://www.youtube.com/embed/_v-TTvIG2-w?start=4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  </div>
  <div class="row">
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
      <div class="ratio ratio-16x9">
      <iframe src="https://www.youtube.com/embed/MZI_5wqkmQ4?start=4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
   ...
   <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
      <div class="ratio ratio-16x9">
      <iframe src="https://www.youtube.com/embed/viqBGbY8CjA?start=4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  </div>
  <div class="row">
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
    <h5 class="text-white text-center">SERVICIO DE PSICOLOGÍA CLÍNICA</h5>
       <p class="text-white">Nuestro centro médico, De Buena Cepa Centro Médico, pone a tu disposición un completo servicio de Psicología Clínica. Esta disciplina altamente especializada 
        se dedica al diagnóstico y tratamiento de una amplia gama de trastornos mentales y emocionales, brindando el apoyo necesario para recuperar y mantener el bienestar psicológico.
        Contamos con un equipo de Psicólogos Clínicos altamente capacitados, quienes ofrecen servicios terapéuticos profesionales y confidenciales. Su compromiso es ayudar a las personas 
        a superar sus dificultades emocionales y promover un camino hacia la recuperación y el crecimiento personal.
        Recuerda, pedir ayuda es un signo de fortaleza y valentía. Te alentamos a buscar el apoyo de profesionales de la salud, tu familia y grupos de apoyo que te rodean, ya que
         encontrar comprensión y aliento es fundamental en este proceso.
       </p>
    </div>
  </div>
</div>
<section class="imgFija mt-5"></section>
<a id="CONTACTO"></a>
...
<div class="container d-flex justify-content-center">
        <form action="procesador/procesa.php" method="POST" class="formularioAjustes">
            ...
            <div class="row">
                ...
                <input type="text" placeholder="Captcha" name="captcha" id="captcha" class="inputsEstilosCap">&nbsp;&nbsp;
                 <img src="img/code.jpg" alt="captcha" class="imgCap">
              </div>
              </div>
              </div> 
                <div class="row">
 ...
 <div class="container">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-1 mb-1">
                <div class="d-flex justify-content-center">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d155467.1023160315!2d-2.0078410049388036!3d52.494099352598674!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487099fc92a3ad61%3A0x80fb90ace73738fb!2sBlack%20Country%20Living%20Museum!5e0!3m2!1ses!2sar!4v1697836640094!5m2!1ses!2sar" class="mapaContacto"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
  </div>
</div>
    </div>  
     <div class="container d-flex justify-content-center">
        <div class="datosContacto">
            <div class="row ">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 ">
                    <div class="d-flex justify-content-center">
                    <p class="text-white"><i class="fa-solid fa-user-doctor"></i><a data-bs-toggle="tooltip" data-bs-placement="top" title="Especialidad: algo">
    ...
    <div class="container d-flex justify-content-center">
        <div class="datosRedes">
            <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 ">
                    <div class="d-flex justify-content-center">
                    <p class="text-white">Sigános en nuestras redes sociales: &nbsp;<a href="www.facebook.com"><i class="fa-brands fa-facebook fa-beat-fade fa-lg  text-color-nav nav-link  fontSizeNav"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.instagram.com/"><i class="fa-brands fa-instagram fa-beat-fade fa-lg  text-color-nav nav-link  fontSizeNav"></i></a></p>
                    </div>
                 </div>  
            </div>
        </div>
...
<script>
   var brw = new Browser();
      ...
      if(brw.name == "firefox"){  
          let seleccionoId = document.querySelector('#videoSiNo');
          seleccionoId.innerHTML = "<div style='width: 100%;height: 350px;' class='mt-4 mb-4 displayNone' id='block' data-vide-bg='videos/ocean' data-vide-options='position: 0% 50%'></div>";
          console.log("-es firefox el navegador usado ahora, ok-");
      }else{
        let seleccionoId = document.querySelector('#videoSiNo');
        seleccionoId.innerHTML = "<div style='width: 100%;height: 350px;' class='mt-4 mb-4' id='block' data-vide-bg='videos/ocean' data-vide-options='position: 0% 50%'></div>"
      }
</script>
